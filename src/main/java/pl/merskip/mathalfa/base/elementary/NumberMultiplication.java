...
public class NumberMultiplication implements Operator, Calculable {
    ...
    public NumberMultiplication(Symbol firstArgument, Symbol secondArgument) {
    ...
    public Symbol calculate(Operation operation) {
        ...
        if (calculatedFirstArgument instanceof RationalNumber
            ...
            return new NumberMultiplication(calculatedFirstArgument, calculatedSecondArgument);
        }
    }
